...
// Barrel: re-exporta los helpers compartidos y las queries por bloque para
// que `page.tsx` y `csv/route.ts` puedan importar todo desde './queries'.
export type { ReportesFilters, SupabaseClient } from './queries/_shared'
export * from './queries/stock'
export * from './queries/demanda'
export * from './queries/tintorerias'
export * from './queries/calidad'
export * from './queries/eficiencia'
