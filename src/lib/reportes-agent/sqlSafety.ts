...
const FORBIDDEN_PATTERNS: { label: string; pattern: RegExp }[] = [
  ...
  { label: 'agregar_partidas_a_pedido', pattern: /\b(public\.)?agregar_partidas_a_pedido\s*\(/i },
  { label: 'actualizar_pedido_remito', pattern: /\b(public\.)?actualizar_pedido_remito\s*\(/i },
  ...
  { label: 'reemplazar_rollo_picking', pattern: /\b(public\.)?reemplazar_rollo_picking\s*\(/i },
